...
export class CreateFirstMigration1709302934154 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "category" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar(50) NOT NULL)`);
        await queryRunner.query(`CREATE TABLE "tag" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar(50) NOT NULL)`);
        await queryRunner.query(`CREATE TABLE "ad" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "title" varchar(100) NOT NULL, "description" varchar(250) NOT NULL, "owner" varchar(100) NOT NULL, "price" integer NOT NULL, "picture" varchar(100) NOT NULL, "location" varchar(50) NOT NULL, "createdAt" datetime NOT NULL, "category_id" integer)`);
